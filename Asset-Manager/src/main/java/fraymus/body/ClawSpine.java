...
public class ClawSpine implements Runnable {
    ...
    /**
     * Create ClawSpine for Discord with token from environment
     * 
     * @param messageHandler Callback for incoming messages (channelId, content)
     */
    public static ClawSpine forDiscord(BiConsumer<String, String> messageHandler) {
        return new ClawSpine(Platform.DISCORD, ConfigManager.getInstance().getDiscordToken(), messageHandler);
    }
    
    /**
     * Create ClawSpine for Discord with explicit token (deprecated - use environment variable)
     * 
    ...
    /**
     * Create ClawSpine for Telegram with token from environment
     * 
     * @param messageHandler Callback for incoming messages (chatId, content)
     */
    public static ClawSpine forTelegram(BiConsumer<String, String> messageHandler) {
        return new ClawSpine(Platform.TELEGRAM, ConfigManager.getInstance().getTelegramToken(), messageHandler);
    }
    
    /**
     * Create ClawSpine for Telegram with explicit token (deprecated - use environment variable)
     * 
