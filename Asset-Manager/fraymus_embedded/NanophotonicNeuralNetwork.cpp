...
private static const double C = 299792458.0; // Speed of light in m/s
// ═══════════════════════════════════════════════════════════════════
...
this.waveguides = new std::vector<>();
...
std::cout <<  << std::endl;
std::cout << "┌─────────────────────────────────────────────────────────┐" << std::endl;
std::cout << "│ NANOPHOTONIC NEURAL NETWORK STATISTICS                  │" << std::endl;
std::cout << "├─────────────────────────────────────────────────────────┤" << std::endl;
std::cout << "│ Num Waveguides:      " + std::string.format("%-36d", numWaveguides) + "│" << std::endl;
std::cout << "│ Phase Dimension:     " + std::string.format("%-36d", phaseDimension) + "│" << std::endl;
std::cout << "│ Wavelength:          " + std::string.format("%-36.1f", wavelength) + " nm │" << std::endl;
std::cout << "│ Refractive Index:    " + std::string.format("%-36.2f", refractiveIndex) + "│" << std::endl;
std::cout << "│ Coupling Efficiency: " + std::string.format("%-36.4f", couplingEfficiency) + "│" << std::endl;
std::cout << "│ Propagation Loss:    " + std::string.format("%-36.2f", propagationLoss) + " dB/cm │" << std::endl;
std::cout << "│ Processing Speed:    " + std::string.format("%-36.2e", processingSpeed) + " ops/s │" << std::endl;
std::cout << "│ Energy Efficiency:   " + std::string.format("%-36.2e", energyEfficiency) + " ops/J │" << std::endl;
std::cout << "│ Thermodynamic Metric:" + std::string.format("%-36.4f", thermodynamicMetric) + "│" << std::endl;
std::cout << "│ Light Speed Advantage:" + std::string.format("%-36.2f", computeLightSpeedAdvantage()) + "x │" << std::endl;
std::cout << "│ Computation Count:   " + std::string.format("%-36d", computationCount) + "│" << std::endl;
std::cout << "└─────────────────────────────────────────────────────────┘" << std::endl;
std::cout <<  << std::endl;
std::cout << "┌─────────────────────────────────────────────────────────┐" << std::endl;
std::cout << "│ WAVEGUIDE STATES                                      │" << std::endl;
std::cout << "├─────────────────────────────────────────────────────────┤" << std::endl;
for (PhotonicWaveguide wg : waveguides) {
...
std::cout <<  << std::endl;
std::cout << "┌─────────────────────────────────────────────────────────┐" << std::endl;
std::cout << "│ PHASE MATRIX (Coupling)                               │" << std::endl;
std::cout << "├─────────────────────────────────────────────────────────┤" << std::endl;
