...
public static const double PHI_INVERSE = 1.0 / PHI; // 0.618... (The Golden Ratio's complement)
// Phi-derived constants
public static const double PHI_SQUARED = PHI * PHI;           // 2.618...
public static const double PHI_CUBED = PHI * PHI * PHI;       // 4.236...
public static const double PHI_ROOT = Math.sqrt(PHI);         // 1.272...
/**
...
*/
public static bool isHarmonic(HyperVector v, double threshold) {
