...
* - History
*/
class FrayBrowserBuilder { {
public:
private static const std::string OUTPUT_DIR = "fraynix_src/apps";
public static void main(std::string[] args) {
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  🌐 FRAY-BROWSER - Gen 151                                    ║" << std::endl;
std::cout << "║  The Web Browser                                              ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
std::cout <<  << std::endl;
try {
...
buildBrowserUI();
std::cout <<  << std::endl;
std::cout << "✅ FRAY-BROWSER COMPILED" << std::endl;
std::cout << "   Usage: browse <url>" << std::endl;
} catch (IOException e) {
System.err.println("❌ BUILD FAILED: " + e.getMessage());
}
}
private static void buildHttpClient() throws IOException {
std::cout << "   [1/4] Generating http.c..." << std::endl;
std::string http = """
/* ═══════════════════════════════════════════════════════════════════════════
...
std::cout << "   [2/4] Generating html.c..." << std::endl;
std::string html = """
/* ═══════════════════════════════════════════════════════════════════════════
...
std::cout << "   [3/4] Generating render_html.c..." << std::endl;
std::string render = """
/* ═══════════════════════════════════════════════════════════════════════════
...
std::cout << "   [4/4] Generating browser.c..." << std::endl;
std::string browser = """
/* ═══════════════════════════════════════════════════════════════════════════
