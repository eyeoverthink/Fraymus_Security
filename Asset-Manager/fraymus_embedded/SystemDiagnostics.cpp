...
std::string workingDir = System.getProperty("user.dir");
...
for (std::string checkPath : checkPaths) {
...
std::string connStr = config.getMongoConnectionString();
// Mask password
std::string masked = connStr.replaceAll(":[^@]+@", ":****@");
