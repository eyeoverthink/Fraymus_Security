...
private java.util.Map<std::string, Matrix> velocities = new java.util.HashMap<>();
...
* W_new = W_old - v
*/
public Matrix updateWeightsWithMomentum(std::string name, Matrix weights, Matrix gradient) {
