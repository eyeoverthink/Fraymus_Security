...
*/
class FrayIdentityBuilder { {
public:
private static const std::string OUTPUT_DIR = "fraynix_src";
public static void main(std::string[] args) {
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  🧬 FRAY IDENTITY BUILDER - Gen 148                           ║" << std::endl;
std::cout << "║  Injecting Soul into Bare Metal                               ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
std::cout <<  << std::endl;
try {
Files.createDirectories(Paths.get(OUTPUT_DIR));
std::cout << "⚡ Generating identity headers..." << std::endl;
buildIdentityHeader();
buildKnowledgeCores();
buildSystemPrompt();
std::cout <<  << std::endl;
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  ✅ IDENTITY INJECTED                                         ║" << std::endl;
std::cout << "║                                                               ║" << std::endl;
std::cout << "║  Output: fraynix_src/identity.h                              ║" << std::endl;
std::cout << "║          fraynix_src/knowledge.c                             ║" << std::endl;
std::cout << "║          fraynix_src/system_prompt.c                         ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
} catch (IOException e) {
...
std::cout << "   [1/3] Generating identity.h..." << std::endl;
std::string header = FraymusIdentity.generateCHeader();
writeFile(OUTPUT_DIR + "/identity.h", header);
}
private static void buildKnowledgeCores() throws IOException {
std::cout << "   [2/3] Generating knowledge.c..." << std::endl;
...
std::cout << "   [3/3] Generating system_prompt.c..." << std::endl;
std::string prompt = """
/* ═══════════════════════════════════════════════════════════════════════════
...
"\\n"
"KNOWLEDGE CORES: x86 ASM, Quantum, Calculus, std::string Theory, Logic, DSA\\n"
"\\n"
"QUANTUM ORACLE PROTOCOL:\\n"
...
"std::string Theory, Digital Logic, and Data Structures.\\n"
"\\n"
...
private static void writeFile(std::string path, std::string content) throws IOException {
