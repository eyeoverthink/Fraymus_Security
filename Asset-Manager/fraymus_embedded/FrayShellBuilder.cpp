...
*/
class FrayShellBuilder { {
public:
private static const std::string OUTPUT_DIR = "fraynix_src";
public static void main(std::string[] args) {
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  ⌨️ FRAY-SHELL BUILDER - Gen 142                              ║" << std::endl;
std::cout << "║  Bare Metal Keyboard Driver & Interactive Shell              ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
std::cout <<  << std::endl;
try {
Files.createDirectories(Paths.get(OUTPUT_DIR));
std::cout << "⚡ Generating kernel components..." << std::endl;
buildKernel();
buildBootloader();
buildLinkerScript();
buildCompileScript();
...
std::cout <<  << std::endl;
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  ✅ FRAYNIX KERNEL GENERATED                                  ║" << std::endl;
std::cout << "║                                                               ║" << std::endl;
std::cout << "║  Output: fraynix_src/                                         ║" << std::endl;
std::cout << "║    ├── kernel.c      (Interactive kernel)                    ║" << std::endl;
std::cout << "║    ├── boot.asm      (Multiboot bootloader)                  ║" << std::endl;
std::cout << "║    ├── linker.ld     (Memory layout)                         ║" << std::endl;
std::cout << "║    ├── grub.cfg      (GRUB configuration)                    ║" << std::endl;
std::cout << "║    └── compile.sh    (Build script)                          ║" << std::endl;
std::cout << "║                                                               ║" << std::endl;
...
std::cout << "   [1/5] Generating kernel.c..." << std::endl;
std::string kernel = """
/* ═══════════════════════════════════════════════════════════════════════════
...
std::cout << "   [2/5] Generating boot.asm..." << std::endl;
std::string boot = """
; FRAYNIX BOOTLOADER
...
std::cout << "   [3/5] Generating linker.ld..." << std::endl;
std::string linker = """
...
std::cout << "   [4/5] Generating compile.sh..." << std::endl;
std::string script = """
#!/bin/bash
...
std::cout << "   [5/5] Generating grub.cfg..." << std::endl;
std::string grub = """
