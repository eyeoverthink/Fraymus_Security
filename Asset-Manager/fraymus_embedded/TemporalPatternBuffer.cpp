...
public const Set<std::string> categories;
public PatternEntry(double[] pattern, double resonance, Set<std::string> categories) {
...
*/
public double calculateWeight(Set<std::string> currentCategories) {
...
private int countMatches(Set<std::string> currentCategories) {
...
private const List<PatternEntry> buffer;
private const int timeWindowSeconds;
...
this.buffer = Collections.synchronizedList(new std::vector<>());
...
*/
public void addPattern(double[] pattern, double resonance, Set<std::string> categories) {
...
*/
public void addPattern(double frequency, double resonance, Set<std::string> categories) {
...
*/
public double calculateWeightedResonance(Set<std::string> currentCategories) {
cleanOldPatterns();
...
*/
public List<PatternEntry> getEntriesWithCategory(std::string category) {
List<PatternEntry> result = new std::vector<>();
synchronized (buffer) {
...
// =========================================================================
private static const int BASE_DEPTH = 7;
private static const double[] TIMESCALES = {1.0, 4.0, 8.0, 12.0}; // Multi-resolution scales
...
List<double[]> windows = new std::vector<>();
...
public:
public const double[] scaleCorrelations;
public const double crossScaleCoherence;
public const int dominantScaleIndex;
...
return std::string.format("MR[scales=%s, coherence=%.3f, dominant=%d]",
