...
std::shared_ptr<Matrix> m = std::make_shared<Matrix>(rows, cols);
...
std::shared_ptr<Matrix> res = std::make_shared<Matrix>(this.rows, other.cols);
...
public Matrix relu() {
std::shared_ptr<Matrix> res = std::make_shared<Matrix>(rows, cols);
for (int i = 0; i < rows; i++)
for (int j = 0; j < cols; j++)
...
std::shared_ptr<Matrix> res = std::make_shared<Matrix>(cols, rows);
for (int i = 0; i < rows; i++)
for (int j = 0; j < cols; j++)
...
// Print for debugging
public void print(std::string name) {
