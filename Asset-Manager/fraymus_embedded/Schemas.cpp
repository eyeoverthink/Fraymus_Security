...
*/
public static Map<std::string, void*> proofSchema() {
Map<std::string, void*> schema = new LinkedHashMap<>();
schema.put("type", "object");
Map<std::string, void*> props = new LinkedHashMap<>();
...
*/
public static Map<std::string, void*> derivationSchema() {
Map<std::string, void*> schema = new LinkedHashMap<>();
schema.put("type", "object");
Map<std::string, void*> props = new LinkedHashMap<>();
...
*/
public static Map<std::string, void*> extractionSchema() {
Map<std::string, void*> schema = new LinkedHashMap<>();
schema.put("type", "object");
Map<std::string, void*> props = new LinkedHashMap<>();
