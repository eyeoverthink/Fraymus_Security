...
*/
class FrayMediaBuilder { {
public:
private static const std::string OUTPUT_DIR = "fraynix_src/apps";
public static void main(std::string[] args) {
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  🎨 FRAY-MEDIA - Gen 151                                      ║" << std::endl;
std::cout << "║  Image Viewer + Audio Player                                  ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
std::cout <<  << std::endl;
try {
...
buildAudioPlayer();
std::cout <<  << std::endl;
std::cout << "✅ FRAY-MEDIA COMPILED" << std::endl;
std::cout << "   Usage: view <image.bmp>" << std::endl;
std::cout << "          play <audio.wav>" << std::endl;
} catch (IOException e) {
System.err.println("❌ BUILD FAILED: " + e.getMessage());
}
}
private static void buildImageViewer() throws IOException {
std::cout << "   [1/2] Generating image.c..." << std::endl;
std::string image = """
/* ═══════════════════════════════════════════════════════════════════════════
...
std::cout << "   [2/2] Generating audio.c..." << std::endl;
std::string audio = """
/* ═══════════════════════════════════════════════════════════════════════════
