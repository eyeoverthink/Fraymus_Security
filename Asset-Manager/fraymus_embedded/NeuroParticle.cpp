...
public std::string entanglementKey;
...
std::shared_ptr<Synapse> synapse = std::make_shared<Synapse>(this, target, weight);
...
return std::string.format("⚛[%s] P=%.2f S=%d D=%d C=%d",
