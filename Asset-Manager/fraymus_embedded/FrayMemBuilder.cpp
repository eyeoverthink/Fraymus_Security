...
*/
class FrayMemBuilder { {
public:
private static const std::string OUTPUT_DIR = "fraynix_src";
public static void main(std::string[] args) {
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  🧠 FRAY MEMORY BUILDER - Gen 145                             ║" << std::endl;
std::cout << "║  Virtual Memory Manager (The Infinite Lie)                   ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
std::cout <<  << std::endl;
try {
Files.createDirectories(Paths.get(OUTPUT_DIR));
std::cout << "⚡ Generating virtual memory system..." << std::endl;
buildPagingSystem();
buildPagingAssembly();
buildHeapManager();
std::cout <<  << std::endl;
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  ✅ VIRTUAL MEMORY SYSTEM INSTALLED                           ║" << std::endl;
std::cout << "║                                                               ║" << std::endl;
std::cout << "║  Output: fraynix_src/paging.c                                ║" << std::endl;
std::cout << "║          fraynix_src/paging.asm                              ║" << std::endl;
std::cout << "║          fraynix_src/heap.c                                  ║" << std::endl;
std::cout << "║                                                               ║" << std::endl;
std::cout << "║  Virtual Space: 4 GB (0x00000000 - 0xFFFFFFFF)               ║" << std::endl;
std::cout << "║  Page Size:     4 KB                                         ║" << std::endl;
std::cout << "║  Page Tables:   1024 entries each                            ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
} catch (IOException e) {
...
std::cout << "   [1/3] Generating paging.c..." << std::endl;
std::string paging = """
/* ═══════════════════════════════════════════════════════════════════════════
...
std::cout << "   [2/3] Generating paging.asm..." << std::endl;
std::string asm = """
; ═══════════════════════════════════════════════════════════════════════════
...
std::cout << "   [3/3] Generating heap.c..." << std::endl;
std::string heap = """
/* ═══════════════════════════════════════════════════════════════════════════
