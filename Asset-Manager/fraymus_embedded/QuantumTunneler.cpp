...
public const std::string circuitName;
public const bool success;
public TunnelResult(BigInteger n, BigInteger p, BigInteger q, int iters, long elapsed, std::string circuit, bool success) {
this.n = n;
this.factorP = p;
this.factorQ = q;
