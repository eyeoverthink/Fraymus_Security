...
this.scaleHierarchy = new std::vector<>();
for (int i = 0; i < maxScales; i++) {
std::shared_ptr<CognitiveAgent> agent = std::make_shared<CognitiveAgent>(i, stateDimension);
...
std::cout <<  << std::endl;
std::cout << "┌─────────────────────────────────────────────────────────┐" << std::endl;
std::cout << "│ SCALE-FREE COGNITION STATISTICS                        │" << std::endl;
std::cout << "├─────────────────────────────────────────────────────────┤" << std::endl;
std::cout << "│ Max Scales:          " + std::string.format("%-36d", maxScales) + "│" << std::endl;
std::cout << "│ State Dimension:     " + std::string.format("%-36d", stateDimension) + "│" << std::endl;
std::cout << "│ Sync Iterations:     " + std::string.format("%-36d", syncIterations) + "│" << std::endl;
std::cout << "│ Coupling Strength:   " + std::string.format("%-36.4f", couplingStrength) + "│" << std::endl;
std::cout << "│ Sync Rate:           " + std::string.format("%-36.4f", synchronizationRate) + "│" << std::endl;
std::cout << "│ Fractal Dimension:   " + std::string.format("%-36.4f", fractalDimension) + "│" << std::endl;
std::cout << "│ Planetary Coherence: " + std::string.format("%-36.4f", planetaryCoherence) + "│" << std::endl;
std::cout << "│ Emergence Level:     " + std::string.format("%-36.4f", emergenceLevel) + "│" << std::endl;
std::cout << "│ Collective Intel:    " + std::string.format("%-36.4f", collectiveIntelligence) + "│" << std::endl;
std::cout << "└─────────────────────────────────────────────────────────┘" << std::endl;
std::cout <<  << std::endl;
std::cout << "┌─────────────────────────────────────────────────────────┐" << std::endl;
std::cout << "│ SCALE HIERARCHY                                        │" << std::endl;
std::cout << "├─────────────────────────────────────────────────────────┤" << std::endl;
for (CognitiveAgent agent : scaleHierarchy) {
...
std::cout <<  << std::endl;
std::cout << "┌─────────────────────────────────────────────────────────┐" << std::endl;
std::cout << "│ MARKOV BLANKET MATRIX                                   │" << std::endl;
std::cout << "├─────────────────────────────────────────────────────────┤" << std::endl;
for (int i = 0; i < maxScales; i++) {
std::cout << "│ ";
for (int j = 0; j < maxScales; j++) {
