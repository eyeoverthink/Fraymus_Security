...
std::cout <<  << std::endl;
std::cout << "┌─────────────────────────────────────────────────────────┐" << std::endl;
std::cout << "│ RENORMALIZING GENERATIVE MODEL STATISTICS               │" << std::endl;
std::cout << "├─────────────────────────────────────────────────────────┤" << std::endl;
std::cout << "│ State Dimension:     " + std::string.format("%-36d", stateDimension) + "│" << std::endl;
std::cout << "│ Observation Dim:     " + std::string.format("%-36d", observationDimension) + "│" << std::endl;
std::cout << "│ Max Scales:          " + std::string.format("%-36d", maxScales) + "│" << std::endl;
std::cout << "│ Update Count:        " + std::string.format("%-36d", updateCount) + "│" << std::endl;
std::cout << "│ Current Free Energy: " + std::string.format("%-36.6f", currentFreeEnergy) + "│" << std::endl;
std::cout << "│ Expected Free Energy:" + std::string.format("%-36.6f", expectedFreeEnergy) + "│" << std::endl;
std::cout << "│ Prediction Error:    " + std::string.format("%-36.6f", predictionError) + "│" << std::endl;
std::cout << "│ Epistemic Value:     " + std::string.format("%-36.6f", epistemicValue) + "│" << std::endl;
std::cout << "│ Precision Weight:    " + std::string.format("%-36.4f", precisionWeight) + "│" << std::endl;
std::cout << "│ Learning Rate:       " + std::string.format("%-36.4f", learningRate) + "│" << std::endl;
std::cout << "│ Temperature:         " + std::string.format("%-36.4f", temperature) + "│" << std::endl;
std::cout << "└─────────────────────────────────────────────────────────┘" << std::endl;
std::cout <<  << std::endl;
std::cout << "┌─────────────────────────────────────────────────────────┐" << std::endl;
