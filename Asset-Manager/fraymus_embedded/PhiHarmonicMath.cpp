...
public static const double PHI_INVERSE = 0.6180339887498949;
public static const double PHI_SQUARED = 2.618033988749895;
public static const double PHI_PI = PHI * Math.PI;  // ≈ 5.083
// Core phi operations
...
public static double calculateFrequencyResonance(std::string text) {
