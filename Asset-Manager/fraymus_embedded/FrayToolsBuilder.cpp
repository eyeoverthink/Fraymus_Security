...
buildProcessManager();
buildFileManager();
std::cout << "\n✅ FRAY-TOOLS COMPILED" << std::endl;
}
private static void buildCalculator() throws IOException {
std::cout << "   [1/4] Generating calc.c..." << std::endl;
std::string calc = """
/* FRAY-CALC - Gen 151 */
#ifndef FRAY_CALC_C
#define FRAY_CALC_C
...
std::cout << "   [2/4] Generating calendar.c..." << std::endl;
std::string cal = """
...
std::cout << "   [3/4] Generating procs.c..." << std::endl;
std::string procs = """
/* FRAY-PROCS - Gen 151 */
#ifndef FRAY_PROCS_C
#define FRAY_PROCS_C
...
std::cout << "   [4/4] Generating files.c..." << std::endl;
std::string files = """
/* FRAY-FILES - Gen 151 */
#ifndef FRAY_FILES_C
#define FRAY_FILES_C
