...
*
* Example: "10 5 + ." → Push 10, Push 5, Add, Print → Output: 15
*
* "The child learns to calculate."
*/
class FrayCompilerBuilder { {
public:
private static const std::string OUTPUT_DIR = "fraynix_src";
public static void main(std::string[] args) {
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  🧱 FRAY COMPILER BUILDER - Gen 143                           ║" << std::endl;
std::cout << "║  Stack-Based Virtual Machine                                  ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
std::cout <<  << std::endl;
try {
Files.createDirectories(Paths.get(OUTPUT_DIR));
std::cout << "⚡ Generating compiler components..." << std::endl;
buildCompiler();
updateKernelWithCompiler();
std::cout <<  << std::endl;
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  ✅ FRAY-C COMPILER INSTALLED                                 ║" << std::endl;
std::cout << "║                                                               ║" << std::endl;
std::cout << "║  Output: fraynix_src/compiler.c                              ║" << std::endl;
std::cout << "║                                                               ║" << std::endl;
std::cout << "║  Usage in FrayShell:                                         ║" << std::endl;
std::cout << "║    fray> run 10 5 + .       → Output: 15                     ║" << std::endl;
std::cout << "║    fray> run 100 50 - .     → Output: 50                     ║" << std::endl;
std::cout << "║    fray> run 7 8 * .        → Output: 56                     ║" << std::endl;
std::cout << "║    fray> run 3 dup * .      → Output: 9                      ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
} catch (IOException e) {
...
std::cout << "   [1/2] Generating compiler.c..." << std::endl;
std::string compiler = """
/* ═══════════════════════════════════════════════════════════════════════════
...
std::cout << "   [2/2] Generating kernel integration patch..." << std::endl;
std::string patch = """
/* ═══════════════════════════════════════════════════════════════════════════
