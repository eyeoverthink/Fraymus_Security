...
FrequencyType(int frequency, std::string description) {
...
private const std::string meaning;
CosmicDimension(int dimension, std::string meaning) {
this.dimension = dimension;
this.meaning = meaning;
}
public int getDimension() { return dimension; }
public std::string getMeaning() { return meaning; }
...
public static const int[] QUANTUM_FREQUENCIES = {432, 528, 639, 999, 4096, 8192, 16384};
public static const int[] COSMIC_DIMENSIONS = {33, 137, 432, 999, 567};
