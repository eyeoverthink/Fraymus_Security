...
class LogicCircuit { {
public:
private static const double PHI = 1.6180339887; // The Universal Constant
private static const double PHI_RECIPROCAL = 0.6180339887; // 1/φ for natural damping
private static const double CHAOS_THRESHOLD = PHI * 2; // Mutation trigger point
...
// Reflex arc state
private bool reflexActive = false;
...
System.err.println("    Momentum: " + std::string.format("%.3f", momentum));
System.err.println("    Temperature: " + std::string.format("%.3f", temperature));
...
std::cout << "    [MUTATION] Strength: " + std::string.format("%.3f", mutationStrength) << std::endl;
std::cout << "    [MUTATION] Phi Modulation: " + std::string.format("%.3f", phiModulation) << std::endl;
...
reflexActive = false;
reflexIntensity = 0.0;
std::cout << "[LOGIC] Circuit reset to initial state" << std::endl;
}
// ═══════════════════════════════════════════════════════════════════
// GETTERS
// ═══════════════════════════════════════════════════════════════════
...
std::cout << "╔═══════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║   🧠 LOGIC CIRCUIT STATUS                                 ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════╝" << std::endl;
std::cout << "  Momentum: " + std::string.format("%.3f", momentum) << std::endl;
std::cout << "  Temperature: " + std::string.format("%.3f", temperature) << std::endl;
std::cout << "  Entropy: " + std::string.format("%.3f", getEntropy()) << std::endl;
std::cout << "  Vitality: " + std::string.format("%.3f", calculateSystemVitality()) << std::endl;
std::cout << "  Mutations: " + mutationCount << std::endl;
std::cout << "  Reflex Active: " + reflexActive << std::endl;
std::cout << "  Chaos State: " + (isChaotic() ? "YES" : "NO") << std::endl;
}
}
