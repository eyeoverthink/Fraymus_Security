...
* "The Face is on."
*/
class FrayDesktopBuilder { {
public:
private static const std::string OUTPUT_DIR = "fraynix_src";
public static void main(std::string[] args) {
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  🖥️ FRAY DESKTOP BUILDER - Gen 146                            ║" << std::endl;
std::cout << "║  Fraymus Desktop Environment                                  ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
std::cout <<  << std::endl;
try {
Files.createDirectories(Paths.get(OUTPUT_DIR));
std::cout << "⚡ Generating desktop environment..." << std::endl;
buildGUIEngine();
buildMouseDriver();
buildWidgets();
std::cout <<  << std::endl;
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  ✅ FRAY DESKTOP INSTALLED                                    ║" << std::endl;
std::cout << "║                                                               ║" << std::endl;
std::cout << "║  Output: fraynix_src/gui.c                                   ║" << std::endl;
std::cout << "║          fraynix_src/mouse.c                                 ║" << std::endl;
std::cout << "║          fraynix_src/widgets.c                               ║" << std::endl;
std::cout << "║                                                               ║" << std::endl;
std::cout << "║  Theme: Cyber-Gold (Obsidian + Gold)                         ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
} catch (IOException e) {
...
std::cout << "   [1/3] Generating gui.c..." << std::endl;
std::string gui = """
...
std::cout << "   [2/3] Generating mouse.c..." << std::endl;
std::string mouse = """
...
std::cout << "   [3/3] Generating widgets.c..." << std::endl;
std::string widgets = """
