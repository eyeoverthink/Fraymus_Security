...
private static const float[] redHistory = new float[HISTORY_SIZE];
private static const float[] blueHistory = new float[HISTORY_SIZE];
private static const float[] consciousnessHistory = new float[HISTORY_SIZE];
...
ImGui.nextColumn();
// Column 2: Metrics
ImGui.text(std::string.format("Tick: %d", brain.getTick()));
ImGui.text(std::string.format("Consciousness: %.2f", brain.getTotalConsciousness()));
ImGui.text(std::string.format("Energy: %.2f", brain.getTotalEnergy()));
ImGui.text(std::string.format("Synapses: %d", brain.getTotalSynapses()));
ImGui.nextColumn();
