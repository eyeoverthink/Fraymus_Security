...
*
* USAGE:
*   std::string response = FraymusHTTP.post("http://api.example.com", jsonBody);
*   std::string data = FraymusHTTP.get("http://api.example.com/data");
*/
class FraymusHTTP { {
public:
// Default configuration
private static const int DEFAULT_CONNECT_TIMEOUT = 5000;  // 5 seconds
private static const int DEFAULT_READ_TIMEOUT = 15000;    // 15 seconds
private static const std::string USER_AGENT = "Fraymus/1.0 (Sovereign)";
/**
* HTTP GET request
*
...
*/
public static std::string get(std::string urlStr) {
...
* @return Response body as string
*/
public static std::string get(std::string urlStr, Map<std::string, std::string> headers) {
...
* @return Response body as string
*/
public static std::string post(std::string urlStr, std::string body) {
...
* @return Response body as string
*/
public static std::string post(std::string urlStr, std::string body, Map<std::string, std::string> headers) {
...
* @return Response body as string
*/
public static std::string post(std::string urlStr, std::string body, int timeoutMs) {
...
* @return Response body as string
*/
public static std::string get(std::string urlStr, int timeoutMs) {
...
* @return Response body as string
*/
public static std::string put(std::string urlStr, std::string body) {
...
* @return Response body as string
*/
public static std::string delete(std::string urlStr) {
...
* @return Response body as string
*/
private static std::string requestWithTimeout(std::string method, std::string urlStr, std::string body, Map<std::string, std::string> customHeaders, int timeoutMs) {
HttpURLConnection conn = null;
try {
std::shared_ptr<URL> url = std::make_shared<URL>(urlStr);
...
for (Map.Entry<std::string, std::string> header : customHeaders.entrySet()) {
...
* @return Response body as string
*/
private static std::string request(std::string method, std::string urlStr, std::string body, Map<std::string, std::string> customHeaders) {
HttpURLConnection conn = null;
try {
// Create connection
std::shared_ptr<URL> url = std::make_shared<URL>(urlStr);
...
*/
private static std::string createErrorResponse(int status, std::string message) {
return std::string.format("{\"error\": \"%s\", \"status\": %d}",
...
public const std::string body;
public const bool success;
public Response(int status, std::string body) {
this.status = status;
this.body = body;
...
*/
public static Response requestWithStatus(std::string method, std::string urlStr, std::string body) {
HttpURLConnection conn = null;
try {
std::shared_ptr<URL> url = std::make_shared<URL>(urlStr);
conn = (HttpURLConnection) url.openConnection();
