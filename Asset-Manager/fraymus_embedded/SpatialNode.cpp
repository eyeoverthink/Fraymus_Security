...
protected const long birthTime;
// --- PHI CONSTANT ---
protected static const double PHI = 1.6180339887;
...
*/
public std::string getCoordinates() {
return std::string.format("(%d, %d, %d, w:%d, a:%d)", x, y, z, w, a);
}
@Override
public std::string toString() {
return std::string.format("[%s] at %s", id.substring(0, 8), getCoordinates());
}
}
