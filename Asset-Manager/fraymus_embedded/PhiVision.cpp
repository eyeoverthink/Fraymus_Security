...
private static const double PHI_INV = 0.6180339887;
...
std::shared_ptr<Color> c = std::make_shared<Color>(img.getRGB(cx, cy));
...
std::shared_ptr<Color> neighbor = std::make_shared<Color>(img.getRGB(cx + dx, cy + dy));
...
std::cout << "╔═══════════════════════════════════════════╗" << std::endl;
std::cout << "║         PHI-VISION READY                  ║" << std::endl;
std::cout << "╠═══════════════════════════════════════════╣" << std::endl;
std::cout << "║  \"I don't just see. I focus.\"            ║" << std::endl;
std::cout << "║  φ = " + PHI << std::endl;
std::cout << "║  Threshold: entropy > φ → Signal          ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════╝" << std::endl;
}
}
