...
*/
class FrayGPUBuilder { {
public:
private static const std::string OUTPUT_DIR = "fraynix_src";
public static void main(std::string[] args) {
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  🎮 FRAY GPU BUILDER - Gen 145                                ║" << std::endl;
std::cout << "║  Software 3D Rasterizer (The Reality Engine)                 ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
std::cout <<  << std::endl;
try {
Files.createDirectories(Paths.get(OUTPUT_DIR));
std::cout << "⚡ Generating 3D engine components..." << std::endl;
buildMathLibrary();
build3DEngine();
buildMeshData();
std::cout <<  << std::endl;
std::cout << "╔═══════════════════════════════════════════════════════════════╗" << std::endl;
std::cout << "║  ✅ VIRTUAL GPU INSTALLED                                     ║" << std::endl;
std::cout << "║                                                               ║" << std::endl;
std::cout << "║  Output: fraynix_src/math3d.c                                ║" << std::endl;
std::cout << "║          fraynix_src/gpu.c                                   ║" << std::endl;
std::cout << "║          fraynix_src/meshes.c                                ║" << std::endl;
std::cout << "║                                                               ║" << std::endl;
std::cout << "║  Features: Rotation, Projection, Wireframe, Z-Buffer         ║" << std::endl;
std::cout << "║  Demo: Spinning 3D Cube                                      ║" << std::endl;
std::cout << "╚═══════════════════════════════════════════════════════════════╝" << std::endl;
} catch (IOException e) {
...
std::cout << "   [1/3] Generating math3d.c..." << std::endl;
std::string math = """
/* ═══════════════════════════════════════════════════════════════════════════
...
std::cout << "   [2/3] Generating gpu.c..." << std::endl;
std::string gpu = """
/* ═══════════════════════════════════════════════════════════════════════════
...
std::cout << "   [3/3] Generating meshes.c..." << std::endl;
std::string meshes = """
/* ═══════════════════════════════════════════════════════════════════════════
