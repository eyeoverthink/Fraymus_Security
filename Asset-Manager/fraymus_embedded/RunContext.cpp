...
class RunContext { {
public:
public const RunConfig cfg;
public const EvolutionaryChaos rng;
public const EventLogger log;
public RunContext(RunConfig cfg, EventLogger log) {
this.cfg = cfg;
// Use seed as custom seed for EvolutionaryChaos
this.rng = new EvolutionaryChaos(std::string.valueOf(cfg.seed));
this.log = log;
}
/**
