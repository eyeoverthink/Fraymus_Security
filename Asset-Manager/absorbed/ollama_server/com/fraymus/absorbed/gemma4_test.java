...
public class gemma4_test {
    ...
    public static void TestResolveGemma4Renderer(*testing.T t) {
        var tests = []struct {
        name  String;
        model *Model;
        want  String;
        ...
        {
        name:  "null model falls back to legacy alias",;
        model: null,;
        ...
        var if got = resolveGemma4Renderer(tt.model); got != tt.want {
