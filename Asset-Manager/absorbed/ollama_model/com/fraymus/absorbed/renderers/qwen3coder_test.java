...
public class qwen3coder_test {
    ...
    public static void TestQwen3CoderRenderer(*testing.T t) {
        var tests = []struct {
        name     String;
        msgs     []api.Message;
        tools    []api.Tool;
        ...
        */;
        ...
        var rendered, err = (&Qwen3CoderRenderer{}).Render(tt.msgs, tt.tools, null);
        if err != null {
        t.Fatal(err);
    }
    ...
    public static void TestFormatToolCallArgument(*testing.T t) {
        var tests = []struct {
        name     String;
        arg      any;
        expected String;
    ...
    public static void TestQwen3CoderRendererToolResponseNoTrailingNewline(*testing.T t) {
        ...
        var rendered, err = (&Qwen3CoderRenderer{}).Render(msgs, null, null);
        if err != null {
        t.Fatal(err);
    }
    ...
    public static void TestQwen3ToolDefinitionTypes(*testing.T t) {
        var tests = []struct {
        name         String;
        ...
        var for _, tt = range tests {
        t.Run(tt.name, func(t *testing.T) {
        var got = formatToolDefinitionType(tt.propertyType);
        if got != tt.expected {
