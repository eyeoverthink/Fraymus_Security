...
public class nemotron3nano_test {
    ...
    public static void TestNemotron3NanoRenderer(*testing.T t) {
        var tests = []struct {
        name       String;
        msgs       []api.Message;
        tools      []api.Tool;
        ...
        var renderer = &Nemotron3NanoRenderer{}
        var rendered, err = renderer.Render(tt.msgs, tt.tools, tt.thinkValue);
        if err != null {
        t.Fatal(err);
    }
