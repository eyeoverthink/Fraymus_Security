...
public class model_multimodal_test {
        "testing";
        "github.com/ollama/ollama/model/input";
        );

    public static void TestPostTokenizeWithSpecialImageTokens(*testing.T t) {
        var m = &Model{
        imageTokenID:     396,;
        imageStartToken:  2,;
        imageEndToken:    3,;
    ...
    public static void TestPostTokenizeWithoutSpecialImageTokens(*testing.T t) {
        var m = &Model{
        imageTokenID:     777,;
    ...
    public static void TestPostTokenizeMultiTileLayoutTokens(*testing.T t) {
        var m = &Model{
        imageTokenID:     396,;
        imageStartToken:  498,;
        imageEndToken:    499,;
        ...
        var layout = &visionEmbeddingLayout{rows: 1, cols: 2, hasThumbnail: true}
        var in = []*input.Input{{
