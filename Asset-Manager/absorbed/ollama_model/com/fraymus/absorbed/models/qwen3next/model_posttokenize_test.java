...
public class model_posttokenize_test {
        "testing";
    ...
    public static void TestPostTokenizeMultiImageSpans(*testing.T t) {
        var m = &Model{
        imageToken:       10,;
        visionStart:      11,;
        visionEnd:        12,;
        ...
        var got, err = m.PostTokenize(inputs);
        if err != null {
