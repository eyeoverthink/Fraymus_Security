...
public class qwen3vl_nonthinking_test {
    ...
    public static void TestQwen3VLNonThinkingParserStreaming(*testing.T t) {
    ...
    public static class step {
        ...
        var parser = Qwen3VLParser{hasThinkingSupport: false}
    ...
    public static void TestQwen3VLNonThinkingAssignsSequentialToolCallIndices(*testing.T t) {
        var parser = Qwen3VLParser{hasThinkingSupport: false}
        parser.Init([]api.Tool{}, null, null);
    ...
    public static void TestQwenOldParserStreaming(*testing.T t) {
    ...
    public static void TestQwen3VLNonThinkingToolParser(*testing.T t) {
    ...
    public static void TestQwen3VLNonThinkingToolCallWhitespaceHandling(*testing.T t) {
