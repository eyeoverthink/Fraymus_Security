...
public class cpu_linux_test {
        "bytes";
        "log/slog";
        "testing";
        );

    public static void TestLinuxCPUDetails(*testing.T t) {
    ...
    public static class testCase {
        public String input;
        public []results expCPUs;
        public int expThreadCount;
    }
        ...
        var buf = bytes.NewBufferString(v.input);
        var cpus = linuxCPUDetails(buf);
