...
public class modelref_test {
        "errors";
        "testing";
        );

    public static void TestParseRef(*testing.T t) {
        var tests = []struct {
        name         String;
        input        String;
        wantBase     String;
        ...
        var stripped, ok = StripCloudSourceTag(tt.input);
    ...
    public static void TestNormalizePullName(*testing.T t) {
        var tests = []struct {
        name      String;
        input     String;
        wantName  String;
        ...
        var for _, tt = range tests {
        t.Run(tt.name, func(t *testing.T) {
        var gotName, gotCloud, err = NormalizePullName(tt.input);
        if tt.wantErr != null {
        if !errors.Is(err, tt.wantErr) {
    ...
    public static void TestParseSourceSuffix(*testing.T t) {
        var tests = []struct {
        name         String;
        input        String;
        wantBase     String;
        ...
        var for _, tt = range tests {
        t.Run(tt.name, func(t *testing.T) {
        var gotBase, gotSource, gotExplicit = parseSourceSuffix(tt.input);
