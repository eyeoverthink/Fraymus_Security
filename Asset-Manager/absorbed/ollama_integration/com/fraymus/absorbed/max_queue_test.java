...
public class max_queue_test {
    ...
    public static void TestMaxQueue(*testing.T t) {
        ...
        var resp = []String{"explore", "discover", "ocean"}
        ...
        var busyCount = 0;
        var resetByPeerCount = 0;
        var canceledCount = 0;
        var successCount = 0;
        var counterMu = sync.Mutex{}
        var embedwg sync.WaitGroup;
        var for i = 0; i < threadCount; i++ {
        embedwg.Add(1);
        go func(i int) {
        defer embedwg.Done();
        ...
        var resp, genErr = client.Embeddings(embedCtx, &embedReq);
        counterMu.Lock();
