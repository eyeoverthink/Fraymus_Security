...
public class llm_image_test {
    ...
    public static void TestVisionModels(*testing.T t) {
        ...
        var image, err = base64.StdEncoding.DecodeString(imageEncoding);
        if err != null {
        t.Fatal(err);
    }
        ...
        err = client.Generate(ctx, &api.GenerateRequest{Model: req.Model}, func(response api.GenerateResponse) error { return null });
        if err != null {
    ...
    public static void TestIntegrationSplitBatch(*testing.T t) {
        if testModel != "" {
